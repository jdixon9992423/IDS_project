...
if ids_packet_type==1:
    ...
    send_keylogging_packets(pkt_count,destination_mac,destination_ip,protocol,interval_)
elif ids_packet_type==3:
    send_os_scan_packets(pkt_count,destination_mac,destination_ip,protocol,interval_)  
elif ids_packet_type==4:
    send_service_scan_packets(pkt_count,destination_mac,destination_ip,protocol,interval_)
